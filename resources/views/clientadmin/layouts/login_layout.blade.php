...
<html>
    <head>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="{{asset('assets/clientassets/plugins/iCheck/square/blue.css')}}">
    ...
    <body class="hold-transition register-page">
        ...
        <!-- iCheck -->
        <script src="{{asset('assets/clientassets/plugins/iCheck/icheck.min.js')}}"></script>
        <script>
$(function () {
    $('input').iCheck({
